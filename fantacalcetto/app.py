...
def reset_identity_sequences(connection):
    if USE_POSTGRES:
        for table in ("leagues", "players", "matches", "award_types", "match_awards", "password_reset_requests", "league_events", "league_event_comments", "match_comments"):
            connection.execute(
                f"""
                select setval(
...
def import_payload(payload):
    ...
    for table in ("leagues", "players", "matches", "award_types", "match_players", "match_awards", "password_reset_requests", "league_events", "league_event_comments", "match_comments"):
